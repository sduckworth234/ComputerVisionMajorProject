...
class courtDataset(Dataset):
    ...
    def __init__(self, mode, input_height=720, input_width=1280, scale=2, hp_radius=55, max_samples=None):
        ...
        self.path_dataset = '/Users/aristathis/Downloads/data'
        ...
        print('mode = {}, len = {}{}'.format(
            mode,
            len(self.data),
            '' if self.max_samples is None else f' (limited from {self.total_len})'
        ))
